...
#   - index.html         → las 7 query strings ?v=NN de cache-busting de los <script>
#
...
# 3) index.html — 7 query strings ?v=NN de los scripts js/*.js
...
echo "  - index.html (7 query strings ?v= de los <script>)"
echo
