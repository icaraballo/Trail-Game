...
const TRAINING_BLOCKS=[
  {id:'volumen',name:'Volumen alto',desc:'Largas tiradas, base aeróbica.',detail:'Ideal para ultras y resistencia.',
  ...
  {id:'velocidad',name:'Trabajo de velocidad',desc:'Series y ritmo, ganas en llano.',detail:'Perfecto para media distancia.',
  ...
  {id:'tecnico',name:'Descenso técnico',desc:'Terreno difícil, mejora la bajada.',detail:'Ideal con mucho desnivel negativo.',
  ...
  {id:'recuperacion',name:'Recuperación activa',desc:'Sin forzar, consolidas lo aprendido.',detail:'Bueno tras lesión o temporada dura.',
  ...
  {id:'taper',name:'Descarga / Tapering',desc:'Bajas el volumen, dejas que el cuerpo se active.',detail:'Ningún stat sube — llegas fresco y con las piernas listas.',
  ...
  {id:'cruzado',name:'Entrenamiento cruzado',desc:'Bici, natación o yoga. Mantienes la base sin destruir el cuerpo.',detail:'Ideal en recuperación de lesión o carga muy alta.',
...
const FAME_ACTIONS=[
  {id:'reel',      label:'Subir reel de entrenamiento',  icon:'🎬',
   ...
   hours:2, followers:150, cost:0,  cooldown:1},
  {id:'vlog',      label:'Vlog de una carrera',           icon:'🎥',
   desc:'Más currado. Necesitas haber corrido recientemente.',
   hours:4, followers:400, cost:0,  cooldown:2, reqLastRace:true},
  {id:'solidaria', label:'Carrera solidaria',             icon:'🤝',
   desc:'Imagen pública. Seguidores + reputación con sponsors.',
   hours:6, followers:600, cost:30, cooldown:4, sponsorBonus:true},
  {id:'anuncio',   label:'Rodar anuncio con marca',       icon:'📺',
   desc:'Solo si tienes sponsor activo. Ingresos extra.',
   hours:8, followers:800, cost:0,  cooldown:3, reqSponsor:true, income:150},
  {id:'clinic',    label:'Clínica de trail running',       icon:'🏫',
   desc:'Enseñas a otros. Seguidores + stat Mental.',
   hours:5, followers:350, cost:0,  cooldown:3, statBonus:{mental:1}},
  {id:'podcast',   label:'Entrevista en podcast',         icon:'🎙',
   desc:'Visibilidad media. Sin coste de tiempo alto.',
   hours:2, followers:250, cost:0,  cooldown:2},
];

// Seguidores necesarios para desbloquear beneficios
const FAME_THRESHOLDS=[
  {followers:1000,  label:'Micro-influencer',   benefit:'Mejores ofertas de sponsors locales'},
  {followers:5000,  label:'Conocido en el trail',benefit:'Invitaciones a carreras regionales'},
  {followers:15000, label:'Referente nacional',  benefit:'Sponsors nacionales te contactan'},
  {followers:50000, label:'Figura del trail',    benefit:'Invitaciones élite automáticas'},
];
// ══════════════════════════════════════
